...
video = cv2.VideoCapture('carsOhHighway.mp4')
...
async def handler(websocket, path):
    await websocket.send("Sending love")
    webSoketAddress = websocket
...
def trackMultipleObjects():
    ...
    while True:
        ...
        for carID in carIDtoDelete:
            ...
            print("WS Message " + str(carID) + ' current location. ')
            #websocket.send("WS Message " + str(carID) + ' current location. ')
